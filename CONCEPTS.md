...
- **Host ≠ Peer.** Host decides: mint/verify Cap, dispatch, lineage, project, Result. Peer carries out: apply Ops under profile. [LAW.md §4](LAW.md#4-host-and-peer) · [EXPLAIN.md — Why Host ≠ Peer](EXPLAIN.md#why-host--peer) · [Host ≠ Peer](diagrams/02-host-peer.svg)
