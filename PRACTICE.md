...
3. **Peer never mints.** Peer apply only — no root mint, no invented business truth. Instant miss: [KILL.md K3](KILL.md#instant-disqualification). Figure: [Host ≠ Peer](diagrams/02-host-peer.svg). Order: [PSEUDOCODE.md](PSEUDOCODE.md).
